...
public class RouteFactory implements HandlerFactory {
    ...
    public void createHandlers() {
        List<MVCRoute> routes = this.extractRoutesFromControllers();
    ...
    private List<MVCRoute> extractRoutesFromControllers() {
        ...
        config.forEachControllerPackage(controllerPackage -> {
            ...
            controllers.forEach(controller -> routes.addAll(this.extractRoutesFromController(controller)));
        });
        return routes;
    }
