...
public class VertxNubes {
    ...
    public VertxNubes(Vertx vertx, JsonObject json) {
        this.vertx = vertx;
        this.config = Config.fromJsonObject(json, vertx);
        this.deploymentIds = new ArrayList<>();
        this.registry = new ParameterAdapterRegistry();
        ...
        this.registerAnnotationProcessor(View.class, new ViewProcessorFactory(templManager));
        this.registerAnnotationProcessor(File.class, new FileProcessorFactory());
        this.registerMarshaller("text/plain", new PlainTextMarshaller());
        this.registerMarshaller("application/json", new JacksonPayloadMarshaller());
        ...
        if (domainPackage != null) {
            try {
                ...
                this.registerMarshaller("application/xml", new JAXBPayloadMarshaller(reflections.getSubTypesOf(Object.class)));
        ...
        this.registerAnnotationHandler(Cookies.class, cookieHandler);
        this.registerAnnotationHandler(CookieValue.class, cookieHandler);
        this.registerAnnotationHandler(Throttled.class, RateLimitationHandler.create(config));
        this.registerTypeProcessor(PaginationContext.class, new PaginationProcessor());
        this.registerTypeProcessor(Payload.class, new PayloadTypeProcessor(marshallers));
        this.registerAnnotationProcessor(Redirect.class, new ClientRedirectProcessorFactory());
        this.registerAnnotationProcessor(ContentType.class, new ContentTypeProcessorFactory());
        this.registerAnnotationProcessor(Logout.class, new LogoutProcessor());
    }
